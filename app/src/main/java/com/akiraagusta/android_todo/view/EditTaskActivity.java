...
import com.akiraagusta.android_todo.contract.EditTaskContract;
import com.akiraagusta.android_todo.databinding.ActivityEditTaskBinding;
import com.akiraagusta.android_todo.interactor.EditTaskInteractor;
import com.akiraagusta.android_todo.presenter.EditTaskPresenter;
...
public class EditTaskActivity extends AppCompatActivity implements EditTaskContract.View, View.OnClickListener, View.OnTouchListener {
    ...
    public void onEditButtonClick(){
        Task task = new Task(binding.editTitle.getText().toString(),
